...
public class ArsitekView {
    ...
    private static Object[] col = {"ID","Nama Arsitek","No. Telp"};
    ...
    private static void SettingNav(){
        bMarketing.setBounds(425, 500, 100, 30);
    ...
    {
        String sql = "SELECT*FROM arsitek";
        ...
        try {
            while(s.next())
            {
                model.addRow(new Object[]{
                    s.getInt("ID_ARSITEK"),
                    s.getString("NAMA_ARSITEK"),
                    s.getString("TELP_KANTOR")});
            }
    ...
    private static void Action(){
        ...
        bInsert.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent ae) {
                ...
                pd.InsertAMP(tabel, "Id_Arsitek.nextval", tfNamaInsert.getText(), tfTelpInsert.getText());
                getdata();
            }
        });
